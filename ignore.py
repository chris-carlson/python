...
class Ignore:
    ...
    FILES: List[Regex] = [Regex(r'\.class$'), Regex(r'\.classpath$'), Regex(r'\.d.ts$'), Regex(r'\.DS_Store$'),
            Regex(r'\.factorypath$'), Regex(r'\.ico$'), Regex(r'\.ini$'), Regex(r'\.jpeg$'), Regex(r'\.jpg$'),
            Regex(r'\.lock$'), Regex(r'\.min.js$'), Regex(r'^package-lock.json$'), Regex(r'\.png$'),
            Regex(r'\.project$'), Regex(r'\.pyc$'), Regex(r'\.pyo$'), Regex(r'\.pyd$'), Regex(r'\.xlsx$')]
