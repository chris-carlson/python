...
class HtmlReader:
    ...
    def _convert_element(self, native_element: Tag) -> HtmlTag:
        wrapper_attributes: Dict[str, str] = self._convert_attributes(native_element.attrs)
    ...
    def _convert_attributes(self, native_attributes: Dict[str, object]) -> Dict[str, str]:
